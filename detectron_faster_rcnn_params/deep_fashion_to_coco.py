...
def dump_annotation_file(IS_TRAINING=True):
    ...
    SAVE_PATH = 'instances_train2014.json' if IS_TRAINING else 'instances_minival2014.json'
    ...
    detectron_path = '/home/feiliu/Desktop/cs231N_Spring_2018/final_project/detectron_final_project/Detectron/'
    coco_path = detectron_path + 'detectron/datasets/data/coco/annotations/'
    ...
    for image_dic in images:
        ...
        #     bbox_coors = []
        # else: 
        # area = bbox_coors[0][2]*bbox_coors[0][3]
        area = bbox_coors[2]*bbox_coors[3]
        dic2 = {'segmentation': [], 'area': area,
